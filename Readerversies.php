...
if (Auth::is_logged_in()) {
    if ($reader == 'Agrident') {
        ...
        include "toonvelden-readerversies.js.php";
...
<?php
            if ($afgerond == 'Ja') { 
?>
    <input type="submit" name= <?php echo "knpNogmaals_$Id"; ?> value="Nogmaals downloaden" style = "font-size:12px;"> 
<?php 
            }
            else { 
?>
    <input type="submit" name= <?php echo "knpAfronden_$Id"; ?> value="Downloaden afronden" style = "font-size:12px;"> 
<?php 
            } 
?>
 </td>
...
?> <img src='Readerversies.jpg'  width='970' height='550'/>
<?php 
    }
