...
const search = document.querySelector('.input-group input'),
    table_rows = document.querySelectorAll('tbody tr'), /* tbody is een element binnen test_javascript4.php */
    table_headings = document.querySelectorAll('thead th'); /* thead is een element binnen test_javascript4.php */


/******* script voor zoeken en filteren ******/
...
/******* Einde script voor zoeken en filteren ******/
...
table_headings.forEach((head, i) => { /* head is een willekeurige naam als variabele. i is nodig als je door de rijen wilt heen lopen bijv. bij code row.querySelectorAll('td')[i] en sortTable(i); */
    ...
    head.onclick = () => { /* als er op een heading wordt geklikt */
        ...
        head.classList.add('active'); /* Hanteer de style active op de gekozen header (Zie test4_sorteren_zoeken.css) */
        ...
        head.classList.toggle('asc', sort_asc) /* asc is een style class in test4_sorteren_zoeken.css) */
...
function sortTable(column, sort_asc) {
    [...table_rows].sort((a,b) => { // De 3 punten wordt uitgelegd op minuut 11:55
