...
") or die (mysqli_error($db)); 
    ...
    $verw = mysqli_fetch_array($zoek_readerRegel_verwerkt);
...
") or die (mysqli_error($db));
    ...
    $zraf = mysqli_fetch_assoc($zoek_relatie_afvoer);
    $rel_best = $zraf['relId'];
...
$zoek_stalId_afvoer = mysqli_query($db,$zoek_stalId_afvoer) or die (mysqli_error($db));
    ...
    $zsa = mysqli_fetch_assoc($zoek_stalId_afvoer);
    $stalId_afv = $zsa['stalId']; 
    $ubn_herk = $zsa['ubn'];
...
") or die (mysqli_error($db));
    $za = mysqli_fetch_assoc($zoek_aanwas);
    $aanwas = $za['hisId'];
...
") or die (mysqli_error($db));
     $hId = mysqli_fetch_assoc ($zoek_hisId);
     $hisId_afv = $hId['hisId'];
...
") or die (mysqli_error($db));
    $zsaan = mysqli_fetch_assoc($zoek_stalId_aanvoer);
...
") or die (mysqli_error($db));
    ...
    $zha = mysqli_fetch_assoc($zoek_hisId_aanv);
    $hisId_aanv = $zha['hisId'];

$insert_tblBezet = "
INSERT INTO tblBezet
set hisId = '".mysqli_real_escape_string($db,$hisId_aanv)."', hokId = '".mysqli_real_escape_string($db,$hokId)."' ";
