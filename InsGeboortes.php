...
$zoek_ooi_in_kzlmoeder = $schaap_gateway->zoek_ooi_in_kzlmoeder($lidId, $ooiStId_db);
...
<?php 
if(
   (!isset($_POST['knpVervers_']) && !isset($_POST['knpInsert_']) && $ooi_rd <> NULL && empty($ooi_db) && empty($_POST["kzlOoi_$Id"]) )
||
