...
else if ( (isset($kzlFase) && $kzlFase != 'lam') || (isset($levnr_db) && isset($aanwas_db)) ) { $scenario = 'Aanvoer_ouder'; $rel_herk = $_POST['kzlHerk']; }
...
if($scenario == 'Inscharen') { $rel_herk = $relId_herkomst; }
