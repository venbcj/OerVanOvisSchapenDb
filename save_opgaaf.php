...
foreach ($multip_array as $recId => $id) {
    ...
    foreach ($id as $key => $value) {
        //$fldLiq = 0;
        if ($key == 'chbLiq') {
            $fldLiq = $value; /*echo $key.'='.$value."<br/>";*/
        }
        if ($key == 'kzlRubr') {
            $fldRubr = $value; /*echo $key.'='.$value."<br/>";*/
        }
        if ($key == 'txtDatum') {
            $fldDatum = $value;
        ...
        if ($key == 'txtBedrag') {
            $fldBedrag = $value; /*echo $key.'='.$value."<br/>"; */
        }
        if ($key == 'txtToel') {
            $fldToel = $value; /*echo $key.'='.$value."<br/>"; */
        }
        if ($key == 'chbArch') {
            $fldArch = $value; /*echo $key.'='.$value."<br/>"; */
        }
        if ($key == 'chbDel') {
            $fldDel = $value; /*echo $key.'='.$value."<br/>"; */
        }
    }
    if (!isset($fldLiq)) {
        $fldLiq = 0;
