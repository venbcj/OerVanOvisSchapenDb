...
$versie = '17-5-2019';
/* gemaakt als kopie van HokAfleveren */
$versie = '20-12-2019';
/* tabelnaam gewijzigd van UIT naar uit tabelnaam */
$versie = '14-08-2020';
/* geslacht toegevoegd */
$versie = '30-12-2023';
/* and h.skip = 0 toegevoegd aan tblHistorie en sql beveiligd */
$versie = '07-01-2024';
/* Select_all toegevoegd en include kalender op een andere plek gezet omdat dit elkaar anders bijt. */
$versie = '14-01-2024';
/* Sortering op fase en werknr */
$versie = '20-01-2024';
/* in nestquery 'uit' is 'and a1.aan = 1' uit WHERE gehaald. De hisId die voorkomt in tblBezet volstaat. Bovendien is bij Pieter hisId met actId 3 gekoppeld aan tblBezet en heeft het veld 'aan' in tblActie de waarde 0. De WHERE incl. 'and a1.aan = 1' geeft dus een fout resultaat. */
$versie = "11-03-2024";
 /* Bij geneste query uit
join tblHistorie h2 on (h1.stalId = h2.stalId and h1.hisId < h2.hisId) gewijzgd naar
join tblHistorie h2 on (h1.stalId = h2.stalId and ((h1.datum < h2.datum) or (h1.datum = h2.datum and h1.hisId < h2.hisId)) )
 I.v.m. historie van stalId 22623. Dit dier is eerst verkocht en met terugwerkende kracht geplaatst in verblijf Afmest 1 */
$versie = '26-12-2024';
/* <TD width = 940 height = 400 valign = "top"> gewijzigd naar <TD align = "center" valign = "top"> 31-12-24 include login voor include header gezet */
$versie = '20-02-2025';
 /* <input type = hidden size = 1 name = <?php echo "chbkies_Id";
?>
 value = 0 > verwijderd */
Session::start();
?>
...
if (Auth::is_logged_in()) {
    ...
    $ID = Session::get("ID");
    /* zorgt het Id wordt onthouden bij het opnieuw laden van de pagina */
...
<!--    **************************************
    ...
    ************************************** -->
    ...
    value = 1 <?php echo $cbKies == 1 ? 'checked' : ''; if ($oke <> 1) { ?> disabled <?php } else { ?> class="checkall" <?php } ?> >
     </td>
    <!-- Aanwasdatum -->
     <td align = center>
...
<?php
        ...
        } elseif(isset($uitvaldm)) {
            echo 'Dit schaap is reeds overleden.';
        }
?>
     </td>
    </tr>
