...
foreach ($array as $recId => $id) {
    if (!$recId) {
        continue; // dit stond hier niet. Hoe kan dat gewerkt hebben? --BCB
    }
// Id ophalen
//echo $recId.'<br>';
// Einde Id ophalen
 ...
 // dit stond onder de volgende ifs, dat kan nooit gewerkt hebben --BCB
    if ($fldFase == 'moeder' && !isset($fldSekse)) {
        $fldSekse = 'ooi';
    } elseif ($fldFase == 'vader' && !isset($fldSekse)) {
        $fldSekse = 'ram';
    }
