...
if($i == 14) { $inhoud = $item -> {$taken[$i]}; $velden = array('ActId', 'Datum', 'MoederTransponder', 'Moeder', 'Drachtig', 'Grootte');
												...
												include "impAgrident_dieren.php";*/ 
												include "impAgrident.php"; }
if($i == 15) { $inhoud = $item -> {$taken[$i]}; $velden = array('ActId', 'Datum', 'Transponder', 'Levensnummer');
												include "impAgrident.php"; }

if($i == 16) { $inhoud = $item -> {$taken[$i]}; $velden = array('ActId', 'Datum', 'RasId', 'DoelId', 'HokId', 'Transponder', 'Levensnummer', 'vdrId', 'Geslacht');
												include "impAgrident.php"; }
echo $i.'<br>';
			 } 
