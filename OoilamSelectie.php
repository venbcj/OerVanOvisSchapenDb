...
<tr>
<td align="right"><input id = "datepicker1" type= text name = "txtWorpVan_" size = "8" value = <?php if (isset($worpvan)) {
echo "$worpvan";
        }
?> ></td>
    <td align="left"><input id = "datepicker2" type= text name = "txtWorpTot_" size = "8" value = <?php if (isset($worptot)) {
    echo "$worptot";
        }
?> >
...
<?php
            while ($mrl = $toon_meerlingen->fetch_assoc()) {
                $aantal = $mrl['aantal'];
                $worp = $mrl['worp'];
?>
...
<?php
                if ($worp <= 6) {
?>
  <input type="checkbox" name= <?php echo "check_$worp"; ?> value = 1 >
<?php
                }
?>
 </td>
