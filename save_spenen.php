...
elseif (isset($kzlHok) && $gener == 'ouder') { $actId = 5; }
elseif (!isset($kzlHok)) { $actId = 7; }

if(isset($actId)) { //Bij meerder keren versturen van pagina bij spenen bestaat $actId niet meer!
