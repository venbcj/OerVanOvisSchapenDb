...
<ul class="header_smal" id = <?php echo $tagid; ?> >
	...
	<li class="dropdown"><span>Registratie</span>
		<div class="dropdown-content">
			...
			<a href='<?php echo $url;?>Med_registratie.php' style = 'color : black' >Medicijn toediening</a></br></br>
			<a href='<?php echo $url;?>Dekkingen.php' style = 'color : black'>Dekkingen / Dracht</a></br></br>
		</div>
	</li>
...
WHERE u.lidId = ".mysqli_real_escape_string($db,$lidId)." and h.skip = 0 and isnull(r.dmmeld) and m.skip <> 1 ") or die (mysqli_error($db));
