...
foreach ($multip_array as $recId => $id) {
    ...
    foreach ($id as $key => $value) {
        if ($key == 'txtLetter' && !empty($value)) {
            $fldLetter = $value;
        }
        if ($key == 'txtRoep' && !empty($value)) {
            $fldRoep = $value;
        }
        if ($key == 'txtVgsl' && !empty($value)) {
            $fldVgsl = $value;
        }
        if ($key == 'txtNaam' && !empty($value)) {
            $fldNaam = $value;
        }
        if ($key == 'txtTel' && !empty($value)) {
            $fldTel = $value;
        }
        if ($key == 'txtGsm' && !empty($value)) {
            $fldGsm = $value;
        }
        if ($key == 'txtMail' && !empty($value)) {
            $fldMail = $value;
        }
        if ($key == 'txtFunct' && !empty($value)) {
            $fldFunctie = $value;
        }
