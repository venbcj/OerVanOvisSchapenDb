...
$listname = array('Relatie', 'Worpverloop', 'Afvoerreden', 'SterfteOorzaak', 'Doodgeboorte', 'Groepen', 'RedenMedicijn', 'Ziekten', 'Behandelingen', 'Medicijnlijst', 'Lokatie', 'SoortBloedonderzoek', 'Behandelplan', 'Dekinfo', 'Ramcode', 'Kleurblok', 'Status', 'Rassenlijst' );
