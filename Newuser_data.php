...
$insert_tblEenheiduser = "INSERT INTO tblEenheiduser (lidId, eenhId)
	...
	FROM tblEenheid
	";
/*echo $insert_tblEenheiduser.'<br>'.'<br>';*/		mysqli_query($db,$insert_tblEenheiduser) or die (mysqli_error($db));
...
$insert_tblElementuser = "INSERT INTO tblElementuser (elemId, lidId)
	...
	ORDER BY elemId
	";
/*echo $insert_tblElementuser.'<br>'.'<br>';*/		mysqli_query($db,$insert_tblElementuser) or die (mysqli_error($db));
...
";
/*echo $insert_tblPartij.'<br>'.'<br>';*/		mysqli_query($db,$insert_tblPartij) or die (mysqli_error($db));
...
$insert_tblRelatie_Rendac = "INSERT INTO tblRelatie (partId, relatie, uitval, actief)
	...
	";
/*echo $insert_tblRelatie_Rendac.'<br>'.'<br>';*/		mysqli_query($db,$insert_tblRelatie_Rendac) or die (mysqli_error($db));
...
$insert_tblRelatie_Vermist = "INSERT INTO tblRelatie (partId, relatie, actief)
	...
	";
/*echo $insert_tblRelatie_Vermist.'<br>'.'<br>';*/		mysqli_query($db,$insert_tblRelatie_Vermist) or die (mysqli_error($db));
...
$insert_tblRubriekuser = "INSERT INTO tblRubriekuser (rubId, lidId)
	...
	ORDER BY rubId;
	";
/*echo $insert_tblRubriekuser.'<br>'.'<br>';*/		mysqli_query($db,$insert_tblRubriekuser) or die (mysqli_error($db));
?>