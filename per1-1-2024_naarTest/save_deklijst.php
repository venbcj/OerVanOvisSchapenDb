...
if(isset($flddekat) && $flddekat <> $ctrdekat) {
	$update_Dekat = "UPDATE tblDeklijst SET dekat = '".mysqli_real_escape_string($db,$flddekat)."' WHERE dekId = '".mysqli_real_escape_string($db,$updId)."' ";
...
if(isset($fldwerpat) && $fldwerpat <> $ctrwerpat) {
	$update_Werpat = "UPDATE tblDeklijst SET werpat = '".mysqli_real_escape_string($db,$fldwerpat)."' WHERE dekId = '".mysqli_real_escape_string($db,$updId)."' ";
