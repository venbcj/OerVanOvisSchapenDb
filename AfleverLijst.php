...
$versie = '8-1-2017'; /* LidId = 1 variabel gemaankt naar lidId = ".mysqli_real_escape_string($db,$lidId)." */
$versie = '28-9-2018'; /* titel.php verwijderd. Zit in header.php samen met Style.css */
$versie = '5-7-2020'; /* wdgn gewijzigd in wdgn_v */
 session_start();  ?>
<html>
<head>
...
where a.af = 1 and st.rel_best = ".mysqli_real_escape_string($db,$bestm)." and h.datum = '$date'
...
where st.lidId = ".mysqli_real_escape_string($db,$lidId)." and s.schaapId = ".$schaapId." and h.actId = 8 and (h.datum + interval art.wdgn_v day) >= sysdate()
") or die (mysqli_error($db));	
