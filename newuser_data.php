...
$insert_tblElementuser = "INSERT INTO tblElementuser (elemId, lidId)
    ...
    ORDER BY elemId
    ";
        mysqli_query($db,$insert_tblElementuser) or Logger::error(mysqli_error($db));
...
";
        ...
        mysqli_query($db,$update_tblElementuser) or Logger::error(mysqli_error($db));
...
";
        mysqli_query($db,$insert_tblPartij) or Logger::error(mysqli_error($db));
...
$insert_tblRelatie_Rendac = "INSERT INTO tblRelatie (partId, relatie, uitval, actief)
    ...
    ";
        mysqli_query($db,$insert_tblRelatie_Rendac) or Logger::error(mysqli_error($db));
...
$insert_tblRelatie_Vermist = "INSERT INTO tblRelatie (partId, relatie, actief)
    ...
    ";
        mysqli_query($db,$insert_tblRelatie_Vermist) or Logger::error(mysqli_error($db));
...
$insert_tblRubriekuser = "INSERT INTO tblRubriekuser (rubId, lidId)
    ...
    ORDER BY rubId;
    ";
        mysqli_query($db,$insert_tblRubriekuser) or Logger::error(mysqli_error($db));
