...
") or die(mysqli_error($db));
    ...
    foreach ($id as $key => $value) {
        if ($key == 'txtdebUbn' && !empty($value)) {
            $fldUbn = $value;
        }
        if ($key == 'txtdebNaam' && !empty($value)) {
            $fldNaam = $value;
        }
        if ($key == 'txtdebPres' && !empty($value)) {
            $fldPres = $value;
        }
        if ($key == 'txtdebStraat' && !empty($value)) {
            $fldStraat = $value;
        }
        if ($key == 'txtdebNr' && !empty($value)) {
            $fldNr = $value;
        }
        if ($key == 'txtdebPc' && !empty($value)) {
            $fldPc = $value;
        }
        if ($key == 'txtdebPlaats' && !empty($value)) {
            $fldPlaats = $value;
        }
        if ($key == 'txtdebTel' && !empty($value)) {
            $fldTel = $value;
        }
        if ($key == 'chkdebActief' && !empty($value)) {
            $fldActief = $value;
        }
    }
