    ...
    if ($modtech == 1) {
        ...
        if (isset($_POST['knpInsert_'])) {
            ...
            if (!empty($dubbel) && $dubbel >= 1) {
                ...
                if ($modfin == 1  && !empty($_POST['insRubriek_'])) {
                    $insRubriek = $_POST['insRubriek_'];
                }
                $artikel_gateway->store($insNaam, $insStdat, $insNhd, $insBtw, $insRelatie, $insRubriek);
            }
        }
        //*****************************
...
<?php if ($modfin == 1) {
?> <br>** t.b.v. automatisch aanmaken factuur na inkopen ! <?php
        }
?>
 </sub></td></tr>
...
<?php
        ...
        // EINDE Aantal artikelen niet in gebruik  ?>
</table>
</form>
    </TD>
<?php
    } else {
        ?> <img src='voer_php.jpg'  width='970' height='550'/> <?php
    }
